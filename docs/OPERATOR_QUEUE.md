# OPERATOR QUEUE — regenerated 2026-09-21T06:47Z (D-854)
...
- RED   log-triage     RED — 14 NEW error class(es) since the baseline. Read ea

## Micro rung — live feed and sheet
- hourly FX/index feed: **7/7 fresh within 3h** · sheet: **0 candidate(s); 5 instrument(s) STALE; 7 instruments live** · manual fills recorded: **0** · kill-switch rows: 2
...
| fwd-canonical-premia-blend | 2026-09-15 | not yet computable | - | elapsed 6d of 365d horizon (Score after >=250 fresh trading days (data past 2026-09-15) ) |
...
| fwd-etf-trend-timing | 2026-09-13 | not yet computable | 7 | 7 paper day(s) since 2026-09-13; first read at 12 months (drawdown claim — needs a drawdown to have happened). |
| fwd-fourfactor-blend-gcshort | 2026-09-16 | not yet computable | - | elapsed 5d of 365d horizon (Score after >=250 fresh trading days past 2026-09-16 or 2027) |
| fwd-ftd-persistence-short | 2026-08-26 | not yet computable | 26 | 26 day(s) of the 728 required. Scored by scripts/ftd-persistence.ts with FROM_D=2026-08-26 and LIQUID_ONLY=1. |
| fwd-goingconcern-distress | 2026-09-15 | not yet computable | - | elapsed 6d of 365d horizon (Score after >=100 fresh going-concern 10-K filings past 2026) |
...
| fwd-hedging-pressure-flip | 2026-08-26 | not yet computable | 26 | 26 day(s) of the 728 required. Scored by scripts/cot-crosssectional.ts and tff-crosssectional.ts with FROM_D s |
| fwd-isa-crypto-parity | 2026-09-13 | not yet computable | 7 | 7 paper day(s) since 2026-09-13 (~0.3 months); first read at 12 months, decision at 24. not-yet-computable, NO |
| fwd-latefiling-distress | 2026-09-16 | not yet computable | - | elapsed 5d of 365d horizon (Score after >=100 fresh NT filings past 2026-09-16 accrue >=) |
...
| fwd-onchain-fee-momentum | 2026-09-15 | not yet computable | - | elapsed 6d of 365d horizon (Score after >=52 fresh non-overlapping weekly observations p) |
| fwd-payout-8 | 2026-08-22 | not yet computable | 30 | 30 day(s) elapsed; rule needs >=12 scored months (~365d) |
...
| fwd-psl-fade | 2026-09-03 | not yet computable | 201 | 201 forward PSL-fade events since 2026-09-03 across 1 instrument(s) with >=20; rule needs >=1000 pooled (~6 mo |
...
| fwd-three-factor-blend | 2026-09-15 | not yet computable | - | elapsed 6d of 365d horizon (Score after >=250 fresh trading days past 2026-09-15 or 2027) |
| fwd-trend-long-parity | 2026-09-13 | not yet computable | 7 | 7 paper day(s) since 2026-09-13 (~0.3 months); first read at 12 months, decision at 24. not-yet-computable, NO |
