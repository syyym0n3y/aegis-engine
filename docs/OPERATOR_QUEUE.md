# OPERATOR QUEUE — regenerated 2026-09-22T07:00Z (D-854)
...
- RED   log-triage     RED — 4 NEW error class(es) since the baseline. Read eac
...
| fwd-canonical-premia-blend | 2026-09-15 | not yet computable | - | elapsed 7d of 365d horizon (Score after >=250 fresh trading days (data past 2026-09-15) ) |
...
| fwd-crypto-lit5 | 2026-08-24 | not yet computable | 29 | 29 calendar day(s) elapsed of the 250 TRADING days the rule requires; forward table last stamped 2026-09-22 |
...
| fwd-direction-4h-xrp-bnb-makerin-takerout | 2026-09-13 | not yet computable | 38 | 38 forward trade(s) since 2026-09-13; the kill clauses read at 200 and the promote clause at 400. not-yet-comp |
| fwd-distress-blend-combined | 2026-09-16 | not yet computable | - | elapsed 6d of 365d horizon (~250+ trading days from 2026-09-16 (first decisive read ~202) |
| fwd-distress-ivol-blend-5 | 2026-09-16 | not yet computable | - | elapsed 6d of 365d horizon (~250+ trading days from 2026-09-16 (first decisive read ~202) |
| fwd-eq-belowPML-liquid-K5-day-clustered | 2026-09-04 | not yet computable | 8 | 8 forward event-days since 2026-09-04 (rule requires >=150 for kill or >=200 for promote). not-yet-computable. |
| fwd-etf-trend-timing | 2026-09-13 | not yet computable | 9 | 9 paper day(s) since 2026-09-13; first read at 12 months (drawdown claim — needs a drawdown to have happened). |
| fwd-fourfactor-blend-gcshort | 2026-09-16 | not yet computable | - | elapsed 6d of 365d horizon (Score after >=250 fresh trading days past 2026-09-16 or 2027) |
| fwd-ftd-persistence-short | 2026-08-26 | not yet computable | 27 | 27 day(s) of the 728 required. Scored by scripts/ftd-persistence.ts with FROM_D=2026-08-26 and LIQUID_ONLY=1. |
| fwd-goingconcern-distress | 2026-09-15 | not yet computable | - | elapsed 7d of 365d horizon (Score after >=100 fresh going-concern 10-K filings past 2026) |
...
| fwd-hedging-pressure-flip | 2026-08-26 | not yet computable | 27 | 27 day(s) of the 728 required. Scored by scripts/cot-crosssectional.ts and tff-crosssectional.ts with FROM_D s |
| fwd-isa-crypto-parity | 2026-09-13 | not yet computable | 9 | 9 paper day(s) since 2026-09-13 (~0.4 months); first read at 12 months, decision at 24. not-yet-computable, NO |
| fwd-latefiling-distress | 2026-09-16 | not yet computable | - | elapsed 6d of 365d horizon (Score after >=100 fresh NT filings past 2026-09-16 accrue >=) |
...
| fwd-onchain-fee-momentum | 2026-09-15 | not yet computable | - | elapsed 7d of 365d horizon (Score after >=52 fresh non-overlapping weekly observations p) |
| fwd-payout-8 | 2026-08-22 | not yet computable | 31 | 31 day(s) elapsed; rule needs >=12 scored months (~365d) |
...
| fwd-placeable-psl-fade-k24 | 2026-09-08 | not yet computable | 39 | 39 forward event(s) since 2026-09-08 across 3 placeable instrument(s); the rule's first read is at 250 and its |
...
| fwd-psl-fade | 2026-09-03 | not yet computable | 214 | 214 forward PSL-fade events since 2026-09-03 across 3 instrument(s) with >=20; rule needs >=1000 pooled (~6 mo |
| fwd-residual-follow | 2026-08-24 | not yet computable | 12 | 12 attribution stamp(s) since the clock start. UNDERPOWERED BY CONSTRUCTION until the stamps are daily: the ru |
...
| fwd-three-factor-blend | 2026-09-15 | not yet computable | - | elapsed 7d of 365d horizon (Score after >=250 fresh trading days past 2026-09-15 or 2027) |
| fwd-trend-long-parity | 2026-09-13 | not yet computable | 9 | 9 paper day(s) since 2026-09-13 (~0.4 months); first read at 12 months, decision at 24. not-yet-computable, NO |
| fwd-tsmom-110 | 2026-09-13 | not yet computable | 9 | 9 paper day(s) since 2026-09-13 (~0.4 months); first read at 12 months, decision at 24. not-yet-computable, NO |
...
| fwd-utc09to10-belowPDL-long-K6-panel17 | 2026-09-04 | 60.643 | 73 | 73 forward events since 2026-09-04: pooled net 60.64bp, gross t 3.43, 13/17 instruments positive (of 17). belo |
| fwd-utc16-abovePDH-long-K6-panel17 | 2026-09-04 | 27.980 | 66 | 66 forward events since 2026-09-04: pooled net 27.98bp, gross t 1.71, 9/17 instruments positive (of 17). below |
| fwd-xmr-asia-rangefade | 2026-09-15 | not yet computable | - | elapsed 7d of 365d horizon (Score after >=150 fresh out-of-sample trades accrue (data pa) |
