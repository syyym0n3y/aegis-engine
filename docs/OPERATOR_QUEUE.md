# OPERATOR QUEUE — regenerated 2026-09-11T10:58Z (D-854)
...
| fwd-crypto-lit5 | 2026-08-24 | not yet computable | 18 | 18 calendar day(s) elapsed of the 250 TRADING days the rule requires; forward table last stamped 2026-09-11 |
...
| fwd-ftd-persistence-short | 2026-08-26 | not yet computable | 16 | 16 day(s) of the 728 required. Scored by scripts/ftd-persistence.ts with FROM_D=2026-08-26 and LIQUID_ONLY=1. |
| fwd-hedging-pressure-flip | 2026-08-26 | not yet computable | 16 | 16 day(s) of the 728 required. Scored by scripts/cot-crosssectional.ts and tff-crosssectional.ts with FROM_D s |
...
| fwd-payout-8 | 2026-08-22 | not yet computable | 20 | 20 day(s) elapsed; rule needs >=12 scored months (~365d) |
...
| fwd-placeable-psl-fade-k24 | 2026-09-08 | not yet computable | 9 | 9 forward event(s) since 2026-09-08 across 3 placeable instrument(s); the rule's first read is at 250 and its  |
...
| fwd-psl-fade | 2026-09-03 | not yet computable | 90 | 90 forward PSL-fade events since 2026-09-03 across 0 instrument(s) with >=20; rule needs >=1000 pooled (~6 mon |
...
| fwd-utc09to10-belowPDL-long-K6-panel17 | 2026-09-04 | not yet computable | 17 | 17 forward events since 2026-09-04 on the 17-panel; below 30, not-yet-computable (rule floors: kill at n>=250, |
| fwd-utc16-abovePDH-long-K6-panel17 | 2026-09-04 | not yet computable | 13 | 13 forward events since 2026-09-04 on the 17-panel; below 30, not-yet-computable (rule floors: kill at n>=250, |
