# OPERATOR QUEUE — regenerated 2026-09-16T05:41Z (D-854)
...
## Forward clocks — 32 registered, none may be re-mined
...
| fwd-crypto-lit5 | 2026-08-24 | not yet computable | 23 | 23 calendar day(s) elapsed of the 250 TRADING days the rule requires; forward table last stamped 2026-09-15 |
...
| fwd-direction-4h-xrp-bnb-makerin-takerout | 2026-09-13 | not yet computable | 10 | 10 forward trade(s) since 2026-09-13; the kill clauses read at 200 and the promote clause at 400. not-yet-comp |
| fwd-eq-belowPML-liquid-K5-day-clustered | 2026-09-04 | not yet computable | 1 | 1 forward event-days since 2026-09-04 (rule requires >=150 for kill or >=200 for promote). not-yet-computable. |
...
| fwd-psl-fade | 2026-09-03 | not yet computable | 159 | 159 forward PSL-fade events since 2026-09-03 across 0 instrument(s) with >=20; rule needs >=1000 pooled (~6 mo |
| fwd-residual-follow | 2026-08-24 | not yet computable | 8 | 8 attribution stamp(s) since the clock start. UNDERPOWERED BY CONSTRUCTION until the stamps are daily: the rul |
