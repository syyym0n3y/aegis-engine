# OPERATOR QUEUE — regenerated 2026-09-12T12:45Z (D-854)
...
| fwd-crypto-lit5 | 2026-08-24 | not yet computable | 19 | 19 calendar day(s) elapsed of the 250 TRADING days the rule requires; forward table last stamped 2026-09-12 |
...
| fwd-ftd-persistence-short | 2026-08-26 | not yet computable | 17 | 17 day(s) of the 728 required. Scored by scripts/ftd-persistence.ts with FROM_D=2026-08-26 and LIQUID_ONLY=1. |
| fwd-hedging-pressure-flip | 2026-08-26 | not yet computable | 17 | 17 day(s) of the 728 required. Scored by scripts/cot-crosssectional.ts and tff-crosssectional.ts with FROM_D s |
...
| fwd-payout-8 | 2026-08-22 | not yet computable | 21 | 21 day(s) elapsed; rule needs >=12 scored months (~365d) |
