...
| **holding cash with an option attached** — pre-deal SPAC shares below trust value | redeemable at trust; the downside is a T-bill, the upside a deal pop | **MEASURED (D-760)**: real and near-riskless (+6.6%/position, 98% positive, ~3%/yr over bills) — and ~$1.3k per name at median volume, universe spread 9–143%/yr. A T-bill with paperwork. Its control exposed D-734b→c: on CORRECT merger dates the de-SPAC underperformance is STRONGER and now significant in the liquid tercile (500d −57%, t −2.88), reversing D-734's "flat liquid". |
...
| rights issues (UK nil-paid rights) | forced sellers of rights at a discount to theoretical value | **UNTESTED (D-758)**: RNS archive floor 2024-02; nil-paid line not quoted where we can see it; cum-rights close fails the TERP observability test (2/2). A +6.5% first-run "premium" was retracted in code. |
| UK retail-only instruments (NS&I Premium Bonds tax-free prize rate; ISA wrapper) | rates only a retail saver can get | **QUANTIFIED (D-758)**: Premium Bonds 4.35% tax-free to £50k; ISA worth 0.63–1.45%/yr alpha-equivalent — forecast-free, larger than any promoted edge (zero). Operator-side, WEALTH_PATH P0. |
...
The reversion sign is consistent and cross-instrument on 1h: session-low breaks reclaim (D-763, 8/8, t -4.80), FVGs are passed through not respected, IFVG break-throughs revert not continue (D-765, 12/12, t̄ -7.0) — the market FADES structural breakouts. All sit at/below the cost line: calibrated priors, not trades. Two SMC staples (FVG-as-support, IFVG-as-continuation) directionally REFUTED. PSL-fade (D-764): clears the pooled OOS cost gate (6.01bp, t3.18, 11/12) but fragile — K24-only, 2025+ NEGATIVE, flat in the cheap FX majors; on forward clock fwd-psl-fade that will likely KILL. FVG/IFVG (D-765) refuted. The lens's honest yield so far: robust reversion SIGNS at/around the cost line, one edge on probation — a calibrated confidence map, not a promoted trade.
