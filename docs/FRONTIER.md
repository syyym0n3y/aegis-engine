...
| **holding cash with an option attached** — pre-deal SPAC shares below trust value | redeemable at trust; the downside is a T-bill, the upside a deal pop | **MEASURED (D-760)**: real and near-riskless (+6.6%/position, 98% positive, ~3%/yr over bills) — and ~$1.3k per name at median volume, universe spread 9–143%/yr. A T-bill with paperwork. Its control exposed D-734b (de-SPAC event dates wrong). |
