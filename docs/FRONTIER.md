...
| **Paid for capital in a primary market** | issuance discounts / concessions exist because the issuer pays for certainty | IPO allocations (UK retail platforms), bond new-issue concession, rights-issue nil-paid | **MEASURED-US (D-754)**: allocated pop +20% mean (t 11), 73% of it in the top decile retail is scaled out of; the buyable first open → +250d is **−27.5% vs IWM, t −10**. A fee paid to allocation, not capital. UK leg (LSE/PrimaryBid) in build. |
