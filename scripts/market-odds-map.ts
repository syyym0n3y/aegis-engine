...
const CLASSES: Cls[] = [
  ...
  { name: "Commodities", universeQ: "trd_bars_deep?asset_class=eq.commodity&select=symbol",
    drivers: "front-month price, COT positioning; FUTURES CURVE contracts 1-4 for CL + NG (EIA keyless, 1983+/1994+, ends 2024-04, D-742); inventories NOT ingested",
    tested: "roll yield / backwardation (CL, NG — D-742), seasonality (built), cross-asset ratios (built)",
    ...
    gap: "curve for GC/ZC/ZW/ZS/HG/SI (no free historical source found — Yahoo lists only live contracts, Stooq bot-blocked, CHRIS deprecated); EIA/USDA inventories (free, unfetched); a free EIA key would make CL/NG live" },
